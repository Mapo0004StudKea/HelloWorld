...
/*
Make a program in java that generates a random number in the interval [1,100].
...
This is repeated until the number is guessed.
Finally, the program must tell how many guesses the user has used.
 */
